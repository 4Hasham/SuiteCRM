...
if(ACLController::checkAccess('HD1_HelpDesk', 'list', true)){
    $module_menu[]=array('index.php?module=HD1_HelpDesk&action=index&return_module=HD1_HelpDesk&return_action=DetailView', $mod_strings['LNK_LIST'],'View', 'HD1_HelpDesk');
}
